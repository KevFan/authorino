...
import (
	...
	mock_auth "github.com/kuadrant/authorino/internal/auth/mocks"
	"github.com/kuadrant/authorino/internal/evaluators"
	"github.com/kuadrant/authorino/internal/evaluators/authorization"
	"github.com/kuadrant/authorino/internal/evaluators/identity"
	"github.com/kuadrant/authorino/internal/httptest"
	"github.com/kuadrant/authorino/internal/json"
	"github.com/kuadrant/authorino/internal/jsonexp"
...
func BenchmarkAuthPipeline(b *testing.B) {
	...
	idConfig := &evaluators.IdentityConfig{JWTAuthentication: identity.NewJWTAuthentication(identity.NewOIDCProviderVerifier(context.TODO(), fmt.Sprintf("http://%v", oidcServerHost), 0), authCredMock)}
